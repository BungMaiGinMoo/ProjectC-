...
namespace Day2
{
    public partial class Page6_UserSignIn : Form
    {
        ...
        public Page6_UserSignIn()
        {
            InitializeComponent();
        }

        private void Page6_UserSignIn_Load(object sender, EventArgs e)
        {
        ...
        private void CreatBot_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // ถ้าผ่านเงื่อนไขทั้งหมด ก็ให้ทำการเพิ่มข้อมูลลงในฐานข้อมูล
                ...
                Page1_Main menu = new Page1_Main();
                menu.Show();
                this.Hide();
            }
            catch (Exception ex)
